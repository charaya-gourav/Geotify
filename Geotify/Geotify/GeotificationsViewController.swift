...
let kCurrentLocationKey = "currentLocationKey"
...
class GeotificationsViewController: UIViewController, AddGeotificationsViewControllerDelegate, MKMapViewDelegate,CLLocationManagerDelegate {
  ...
  override func viewDidLoad() {
    ...
    loadAllGeotifications()
      _ = NSTimer.scheduledTimerWithTimeInterval(5, target: self, selector: #selector(persistCurrentLocation), userInfo: nil, repeats: true)
  }
  
  func persistCurrentLocation() {
  ...
  func locationManager(manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
    ...
    let currentLocation = ["long": long, "lat": lat]
    
    
    NSUserDefaults.standardUserDefaults().setObject(currentLocation, forKey: kCurrentLocationKey)
